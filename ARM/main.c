...
int main(void)
{
    ...
    //LED pins Output
    PyHal_GPIO_SetDir(21,1);//K
    PyHal_GPIO_SetDir(22,0);//Q
    PyHal_GPIO_SetDir(23,0);//R
    PyHal_GPIO_SetDir(24,0);//S
...
//The direction must be et as Output for this GPIO already
