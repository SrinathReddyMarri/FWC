...
double **lin_solv(double **l1, double **l2, double **l3) {
    double **solution = (double**)malloc(3 * sizeof(double*));
    solution[0] = (double*)malloc(sizeof(double));
    solution[1] = (double*)malloc(sizeof(double));
  

    double det = (l1[0][0] * l2[2][0] - l1[2][0] * l2[0][0]);
    double a = l2[1][0] * l3[2][0];
    double b = l3[1][0] * l2[2][0];
    double x = a - b;
    solution[0][0] = x / det;

    double c = l2[0][0] * l1[1][0];
    double d = l2[1][0] * l1[0][0];
    double y = c - d;
    solution[1][0] = det/y;
